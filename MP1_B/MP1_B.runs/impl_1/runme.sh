...
HD_PWD='C:/Users/Alex/MP1_B/MP1_B.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demo1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo1.tcl -notrace
